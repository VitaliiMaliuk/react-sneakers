...
function App() {
    ...
    async function fetchData() {
      try {
        const [cartResponse, favoritesResponse, itemsResponse] =
          await Promise.all([
            axios.get("https://63fcb13f859df29986c25472.mockapi.io/cart"),
            axios.get("https://63fe2268370fe830d9cee7c8.mockapi.io/favorites"),
            axios.get("https://63fcb13f859df29986c25472.mockapi.io/items"),
          ]);
  ...
  const onAddToCart = async (obj) => {
    try {
      ...
      if (findItem) {
        ...
        await axios.delete(
          `https://63fcb13f859df29986c25472.mockapi.io/cart/${findItem.id}`
        );
      } else {
  ...
  const onRemoveItem = (id) => {
    try {
      ...
      alert("Error when delete from cart");
      console.error(error);
    }
  };
